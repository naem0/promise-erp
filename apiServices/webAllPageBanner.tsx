...
export async function fetchCommonBannerSectionData(params: Record<string, unknown> = {},): Promise<BannerSectionApiResponse | null> {
    try {
        ...
        if (!res.ok) {
            throw new Error(`Banner section API error: ${res.status} ${res.statusText}`);
        }
