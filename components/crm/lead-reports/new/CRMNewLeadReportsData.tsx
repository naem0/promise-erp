...
import { getCRMNewLeadReports } from "@/apiServices/crmLeadReportsService";
import Pagination from "@/components/common/Pagination";
import CRMNewLeadReportsTable from "./CRMNewLeadReportsTable";
import CRMNewLeadReportsExportButton from "./CRMNewLeadReportsExportButton";

const CRMNewLeadReportsData = async ({
    searchParams,
}: {
    ...
    let results;
    try {
        results = await getCRMNewLeadReports(params);
    } catch (error: unknown) {
    ...
    if (!reportData.length) {
        return (
            <NotFoundComponent message={results?.message || "No new lead report data found."} />
        );
    }
...
export default CRMNewLeadReportsData;
