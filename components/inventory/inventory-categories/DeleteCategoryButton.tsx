...
import { deleteProductCategory } from "@/apiServices/inventoryCategoriesService";
...
const DeleteCategoryButton = ({ id }: DeleteCategoryButtonProps) => {
    ...
    const handleDelete = () => {
        startTransition(async () => {
            try {
                const res: ApiResponse = await deleteProductCategory(id);
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This product category record will be permanently deleted.
                    </AlertDialogDescription>
                </AlertDialogHeader>
