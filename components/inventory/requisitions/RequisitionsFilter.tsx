...
export default function RequisitionsFilter() {
    ...
    <div className="p-6 mb-6 border rounded-xl bg-card shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
        ...
        <div className="relative md:col-span-2">
          ...
          <Input
            placeholder="Search by challan no or description..."
            className="pl-10"
            {...register("search")}
          />
        </div>
        ...
        <Controller
          ...
          render={({ field }) => (
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="1">Item-based</SelectItem>
                <SelectItem value="2">Amount-based</SelectItem>
              </SelectContent>
            </Select>
          )}
        />
