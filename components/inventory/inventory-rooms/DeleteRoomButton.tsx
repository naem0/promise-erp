...
import { deleteRoom } from "@/apiServices/inventoryRoomsService";
...
const DeleteRoomButton = ({ id }: DeleteRoomButtonProps) => {
    const [isPending, startTransition] = useTransition();

    const handleDelete = () => {
        startTransition(async () => {
            try {
                const res: ApiResponse = await deleteRoom(id);
                ...
                if (error instanceof Error) {
                    ...
                    toast.error("An unknown error occurred while deleting room");
                }
            }
        });
    };
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This room record will be permanently deleted.
                    </AlertDialogDescription>
                </AlertDialogHeader>
