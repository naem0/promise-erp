...
//         </h2>
//         <p>
//           To become a global benchmark in professional transformation and<br></br> sustainable growth.
...
//             {/* Mission */}
//             <div className="">
//               <Card className="text-center bg-[#EFF3EA] shadow hover:shadow-xl h-full">
...
//                   <h3 className="text-xl font-semibold mb-3 text-secondary">Our Mission</h3>
...
//                   <h3 className="text-xl font-semibold mb-3 text-secondary">Our Vision</h3>
...
//                   <h3 className="text-xl font-semibold mb-3 text-secondary">Our Values</h3>
