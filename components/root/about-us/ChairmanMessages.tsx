import { ChairmanMessage, getPublicAllExecutives } from '@/apiServices/employeeService';
    ...
    <div className={`grid px-4 md:grid-cols-[280px_1fr]`}>
      ...
      <div className={`px-4 py-0`}>
        ...
        <div className="">
          ...
          <p className="text-base text-black/80 mt-1">{displayMember?.designation || "Designation"}</p>
