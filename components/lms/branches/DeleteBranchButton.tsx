...
const DeleteBranchButton = ({ id }: DeleteBranchButtonProps) => {
    const [isPending, startTransition] = useTransition();

    const handleDelete = () => {
        startTransition(async () => {
            try {
                const res: ApiResponse = await deleteBranch(id);
                ...
                if (error instanceof Error) {
                    ...
                    toast.error("An unknown error occurred while deleting branch");
                }
            }
        });
    };
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This branch record will be permanently deleted.
                    </AlertDialogDescription>
                </AlertDialogHeader>
