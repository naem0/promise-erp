...
import { deleteBlog } from "@/apiServices/blogsService";
...
const DeleteBlogButton = ({ id }: DeleteBlogButtonProps) => {
    const [isPending, startTransition] = useTransition();

    const handleDelete = () => {
        startTransition(async () => {
            try {
                const res: ApiResponse = await deleteBlog(id);
                ...
                if (error instanceof Error) {
                    ...
                    toast.error("An unknown error occurred while deleting blog");
                }
            }
        });
    };
