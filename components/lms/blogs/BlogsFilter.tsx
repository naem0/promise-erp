...
export default function BlogsFilter({ categories }: BlogsFilterProps) {
    ...
    const currentCategoryId = searchParams.get("blog_category_id") || "";
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <Select
                            ...
                            onValueChange={(value) => {
                                field.onChange(value);
                                handleSelectChange("blog_category_id")(value);
                            }}
                        >
                            <SelectTrigger className="w-full">
