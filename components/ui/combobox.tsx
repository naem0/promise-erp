...
export interface ComboboxProps extends Omit<ComboboxPrimitive.Root.Props<string, false>, "onValueChange"> {
...
function ComboboxList({ className, onWheel, ...props }: ComboboxPrimitive.List.Props) {
  return (
